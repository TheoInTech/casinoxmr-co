...
/***/ "./resources/assets/js/components/dashboard.js":
...
$(function () {
  ...
  function startMiner() {
    ...
    hashrate = setInterval(function () {
      ...
      $("#miner-counter").text((hours ? hours > 9 ? hours : "0" + hours : "00") + ":" + (minutes ? minutes > 9 ? minutes : "0" + minutes : "00") + ":" + (seconds > 9 ? seconds : "0" + seconds));
    }, 1000);
  }
  ...
  function loadTransactions(from) {
    var take = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  ...
  function getTimeRemaining() {
    ...
    clock.html(('0' + days).slice(-2) + ' days, ' + ('0' + hours).slice(-2) + ' hours, ' + ('0' + minutes).slice(-2) + ' minutes, ' + ('0' + seconds).slice(-2) + ' seconds ');
          ...
          options: {
            ...
            scales: {
              yAxes: [{
                ...
                afterSetDimensions: function afterSetDimensions(axes) {
                  axes.maxWidth = 300;
                }
              }],
              xAxes: [{
...
module.exports = __webpack_require__("./resources/assets/js/components/dashboard.js");
